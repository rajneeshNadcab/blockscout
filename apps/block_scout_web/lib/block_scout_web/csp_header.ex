  ...
  def call(conn, _opts) do
    ...
    Controller.put_secure_browser_headers(conn, %{
      "content-security-policy" => "\
        connect-src 'self' #{config[:mixpanel_url]} #{config[:amplitude_url]} #{websocket_endpoints(conn)} wss://*.bridge.walletconnect.org/ https://request-global.czilladx.com/ http://localhost:3000/node-api/ https://dcsscan.io/node-api/ https://raw.githubusercontent.com/trustwallet/assets/ https://registry.walletconnect.org/data/wallets.json http://ec2-52-66-146-60.ap-south-1.compute.amazonaws.com/ https://explorer.dscscan.io https://rpc-mainnet3.wyzthchain.org/ https://https-wyzthscan-org.disqus.com/ https://https-wyzthscan-org.disqus.com/embed.js https://https-wyzthscan-org.disqus.com/count.js https://raw.githubusercontent.com/PranjalNadCab/wyscaleApi/master/wyz.json https://chatapi.blockscan.com/ https://*.poa.network;\
        default-src 'self';\
