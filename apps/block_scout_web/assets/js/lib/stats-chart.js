...
const chartOptions = {
  ...
  //   const data = await axios.get('https://explorer.dscscan.io/node-api/transactions')
  //   return data
  // }

  export const fetchApi = async () => {
    try {
      const response = await axios.get('https://explorer.dscscan.io/node-api/transactions');
