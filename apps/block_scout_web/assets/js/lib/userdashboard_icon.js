...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function displayData() {
    ...
    try {
      const response = await axios.post("https://dscscan.io/node-api/get-user-icon-data/"+username);
  ...
  async function updateData(id, newData) {
    try {
      const response = await axios.put(`https://dscscan.io/node-api/update-user-icon-data/${id}`, newData);
  ...
  async function deleteData(id) {
    try {
      const response = await axios.delete(`https://dscscan.io/node-api/delete-user-icon-data/${id}`);
