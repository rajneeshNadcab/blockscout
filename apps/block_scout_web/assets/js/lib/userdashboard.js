...
//code for modal ends
 ...
 const username = window.sessionStorage.getItem("username")
  ...
  async function displayData() {
    ...
    try {
      const response = await axios.post(`https://dscscan.io/node-api/get-all-user-data/${username}`);
  ...
  async function updateData(id, newUsername, newEmail, newIsVerify, newIsAdmin) {
    try {
      const response = await axios.put(`https://dscscan.io/node-api/get-all-user-data/${id}`, {
  ...
  async function deleteData(id) {
    try {
      const response = await axios.delete(`https://dscscan.io/node-api/get-all-user-data/${id}`);
