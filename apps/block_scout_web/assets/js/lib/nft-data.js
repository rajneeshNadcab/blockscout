...
document.addEventListener("DOMContentLoaded", async function () {
    const topNftApi = await axios.get(`https://dscscan.io/node-api/top-nft`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const latestNftTransactionsApi = await axios.get(`https://dscscan.io/node-api/latest-nft-transfer`);
...
document.addEventListener("DOMContentLoaded", async function () {
  const topMintApi = await axios.get(`https://dscscan.io/node-api/top-nft-transfer`);
